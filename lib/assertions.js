  ...
  create: {
    singPass: (
      ...
      const sfa = {
        ...
        "Y1314500I": {fid: "E6677999933L", coi: "CN", RP: "CORPPASS"},
        "Y1314501U": {fid: "323456789", coi: "MY", RP: "CORPPASS"}
      }
      if (nric.startsWith('Y')) {
        const sfaAccount = sfa[nric] ? sfa[nric] : {fid: "G730Z-H5P96", coi: "DE", RP: "CORPPASS"}
